...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Home;Initial Catalog=NovusnetPRO;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.pk_cliente).HasName("PK__Cliente__1B813E709DEDE30F");

            entity.HasIndex(e => e.cli_cedula, "UQ__Cliente__B42D878B204CD159").IsUnique();
        ...
        {
            entity.HasKey(e => e.pk_Empleado).HasName("PK__Empleado__CBD8BCCFAEA0EE0A");

            entity.HasIndex(e => e.emp_cedula, "UQ__Empleado__9CE039AE43987D19").IsUnique();
        ...
        {
            entity.HasKey(e => e.pk_logging).HasName("PK__Logging__6BC582D16CAAE211");
        ...
        {
            entity.HasKey(e => e.pk_material).HasName("PK__Material__F6CF7429875291F5");

            entity.HasIndex(e => e.ma_codigo, "UQ__Material__E8EA9015C79958D3").IsUnique();
        ...
        {
            entity.HasKey(e => e.pk_orden_material).HasName("PK__Orden_Ma__A6A40916F0E52E45");
        ...
        {
            entity.HasKey(e => e.pk_orden_trabajo).HasName("PK__Orden_Tr__9E4001A176027C2B");
        ...
        {
            entity.HasKey(e => e.pk_servicio).HasName("PK__Servicio__DB197141A0B45616");
